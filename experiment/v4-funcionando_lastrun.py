...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    for thisTask in task:
        ...
        trial = data.Routine(
            name='trial',
            components=[fondo, cam_inicio_viaje, cam_travel_time_text, cam_cost_text, cam_dens_text, cam_sec_text, metro_inicio_viaje_text, metro_travel_time_text, metro_cost_text, metro_dens_text, metro_users_text, uber_inicio_viaje_text, uber_travel_time_text, uber_cost_text, uber_stars_text, uber_gender_text, uber_record_text, respuesta],
        )
